...
export default defineConfig({
  ...
  base: "/mcp-facturacion-electronica-es/",
  integrations: [
    starlight({
          ...
          customSets: [
            {
              ...
              links: ["https://pypi.org/project/mcp-facturacion-electronica-es/", "https://registry.modelcontextprotocol.io/v0/servers?search=io.github.cmendezs/mcp-facturacion-electronica-es"],
            },
          ],
        }),
      ],
